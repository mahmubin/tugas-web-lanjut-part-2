...
@section('isihalaman')
    ...
    <p>
    <h4>Perpustakaan UMSU</h4>
        UPT Perpustakaan UMSU sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia
		...
		ditempat yang cukup representative, mudah diakses baik oleh mahasiswa ataupun kalangan civitas akademika UMSU.
		Disamping itu juga memiliki ribuan koleksi mulai dari Buku, Jurnal, Majalah, Dokumen Penelitian dan berbagai sumber
		referensi lain guna menunjang proses pembelajaran di UMSU.
    ...
    <p>
		...
		ditiap tahunnya yaitu dengan rata-rata 5,18 % pertahun. UPT Perpustakaan UMSU sampai 10 Oktober 2018
